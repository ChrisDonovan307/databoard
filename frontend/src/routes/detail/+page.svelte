      ...
      <div class="card-body">
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              Trends in publication, citation, and downloads over time, across all and within each
            </li>
            <li>
              How are license use, data format, and software availability associated with citation
              and download counts
            </li>
          </ul>
        </div>
