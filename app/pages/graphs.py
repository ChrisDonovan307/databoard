...
layout = html.Div([
    ...
    html.Div([
        html.H1('Iris Dataset Visualizations', style={'textAlign': 'center', 'paddingTop': '20px'}),
        html.Hr()
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.Graph(id='test', figure=hist_graph, style={'height': '400px'}),

            html.H2('Mean Petal Width by Species', style={'textAlign': 'center', 'marginTop': '30px'}),
            html.Div(
                dcc.Graph(id='test2', figure=bar_graph, style={'width': '60%', 'height': '400px'}),
